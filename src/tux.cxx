...
static void banner (int new_play_as_gown=0)
{
  printf ( "\n\n" ) ;
  printf ( "   WELCOME TO: TUXEDO T. PENGUIN - A QUEST FOR HERRING.\n" ) ;
  printf ( "           originally by Steve and Oliver Baker        \n" ) ;
  printf ( "                  <sjbaker1@airmail.net>               \n" ) ;
  printf ( "                     original Game at                  \n");
  printf ( "              http://tuxaqfh.sourceforge.net           \n" ) ;
  printf ( "              but modified by someone though           \n");
  printf ( "\n\n" ) ;
  printf ( "                        #####        \n" ) ;       
  printf ( "                       #######       \n" ) ;  
  printf ( "                       #  #  #       \n" ) ;
  ...
  printf ( "                        ^            \n") ;
  printf ( "                        |            \n") ;
  printf ( "you play as that -------/            \n" ) ;
  printf ( "\n\n");
  if(new_play_as_gown){
    printf("wait, im wrong\n");
  }
}
...
static void cmdline_help ()
{
  ...
  printf ( "  -d                    Enable various internal debug (untested in modern system)\n" ) ;
  printf ( "  -D, --datadir DIR     Load the game data from DIR defaults\n" ) ;
  printf ( "                        to /usr/local/share/games/tux_aqfh\n" ) ;
  printf ( "btw I can't believe if you somehow smart enough to show this message\n") ;
  printf ( "\n" ) ;
}
