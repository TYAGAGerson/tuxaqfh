...
void GlobalState::keyboardInput ( int c )
{
  ...
  */
  ...
  switch ( c )
  {
    ...
    case 256+GLUT_KEY_F1 : hide_status () ; help  () ; break ;
    case 256+GLUT_KEY_F2 : hide_status () ; about () ; break ;
  ...
  if ( currState->cheat_mode )
  {
    switch ( c )
    {
      ...
      case '*' : texture_enable = ! texture_enable ;
      ...
      case '&' : wireframe_enable = ! wireframe_enable ;
      ...
      case '^' : currState->freeze_baddies = ! currState->freeze_baddies ;
                 break ;

      case '%' : tuxState -> much_better () ;
